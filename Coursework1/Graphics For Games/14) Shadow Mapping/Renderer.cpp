...
Renderer::Renderer(Window & parent) : OGLRenderer(parent) {
	...
	light = new Light(Vector3(20,  20, -350.0f),
	...
	floor -> SetTexture(SOIL_load_OGL_texture("../../Textures/brick.tga", SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, SOIL_FLAG_MIPMAPS),0);
	floor -> SetBumpMap(SOIL_load_OGL_texture("../../Textures/brickDOT3.tga", SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, SOIL_FLAG_MIPMAPS),0);
...
Renderer ::~Renderer(void) {
 ...
 void Renderer::DrawMesh() {
	...
	/* modelMatrix = Matrix4::Translation(Vector3(50, 0, -100))*modelMatrix;*/
...
void Renderer::DrawSphere() {
	modelMatrix = Matrix4::Translation(Vector3(light->GetPosition().x, light->GetPosition().y, light->GetPosition().z))*
